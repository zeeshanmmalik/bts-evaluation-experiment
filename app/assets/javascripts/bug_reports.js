(function(){
  ...
  summary_evaluator.prototype.handle_in_out_event = function(event){
    ...
    var suggestion_message = (sentence.hasClass(click_highlight_class) || sentence.hasClass(wrong_highlight_class))? click_to_remove_suggestion_msg : click_to_add_suggestion_msg;
  ...
  summary_evaluator.prototype.handle_click_event = function(event){
    ...
    if(sentence.hasClass(click_highlight_class)){
      sentence.removeClass(click_highlight_class);
      corresponding_sentence.removeClass(click_highlight_class).removeClass(wrong_highlight_class);
    }else if(sentence.hasClass(wrong_highlight_class)){
      sentence.removeClass(wrong_highlight_class);
      corresponding_sentence.removeClass(click_highlight_class).removeClass(wrong_highlight_class);
    }else{
     var click_class_to_apply_to_sentence               = (sentence.hasClass(rails_highlight_class))? click_highlight_class : wrong_highlight_class;
     var click_class_to_apply_to_corresponding_sentence = (corresponding_sentence.hasClass(rails_highlight_class))? click_highlight_class : wrong_highlight_class;

     sentence.addClass(click_class_to_apply_to_sentence);
     corresponding_sentence.addClass(click_class_to_apply_to_corresponding_sentence);
    }
  }
